...
class Company extends \App\Entity\Company implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Company' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Company' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Company' . "\0" . 'customer'];
        }
     ...
     * {@inheritDoc}
     */
    public function getCustomer(): \Doctrine\Common\Collections\Collection
    {
     ...
     * {@inheritDoc}
     */
    public function addCustomer(\App\Entity\Customer $customer): \App\Entity\Company
    {
     ...
     * {@inheritDoc}
     */
    public function removeCustomer(\App\Entity\Customer $customer): \App\Entity\Company
    {
