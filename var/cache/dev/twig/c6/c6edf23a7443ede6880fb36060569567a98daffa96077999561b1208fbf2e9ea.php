...
class __TwigTemplate_309bd753a1fe719bf7b2541a212a3421875d189b077beee0de35ca5bed9a25e2 extends Template
{
    private $source;
    private $macros = [];
...
\t    ";
        ...
        $context['_seq'] = twig_ensure_traversable($context["customers"]);
        foreach ($context['_seq'] as $context["_key"] => $context["customers"]) {
            // line 15
            echo "\t    <li> ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["customers"], "name", [], "any", false, false, false, 15), "html", null, true);
            echo "</li>
\t  
\t    ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['customers'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return array (  112 => 17,  102 => 15,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "customer/index.html.twig", "C:\\xampp\\htdocs\\RestSym\\templates\\customer\\index.html.twig");
    }
}
